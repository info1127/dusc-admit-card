```python
# Streamlit Admit Card Generator
# Install প্রয়োজনীয় package:
...
class AdmitCardPDF(FPDF):
    ...
    def generate_card(self, student, y):
        ...
        self.cell(95, 10, f"ID: {student_id}")
...
Developed by <b>Md. Shahriar Hasan Sabuj</b>
</div>
<br>
""", unsafe_allow_html=True)
...
if st.button("🚀 Generate Admit Cards"):
    ...
    if not exam_name.strip():
        ...
        try:
            ...
            st.success("✅ Admit Cards Generated Successfully!")
